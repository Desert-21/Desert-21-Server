...
public record EnemyFieldConquestFailed(Location location, BattleResult battleResult) implements EventResult {
    ...
    public List<Notification<?>> forCurrentPlayer() {
        var notification = new Notification<>(PLAYERS_CONQUEST_FAILED_NOTIFICATION,
    ...
    public List<Notification<?>> forOpponent() {
        var notification = new Notification<>(ENEMY_CONQUEST_FAILED_NOTIFICATION,
