...
public record UnoccupiedFieldConquestSucceeded(Location location, BattleResult battleResult) implements EventResult {
    ...
    public List<Notification<?>> forCurrentPlayer() {
        var notification = new Notification<>(UNOCCUPIED_FIELD_PLAYERS_CONQUEST_SUCCEEDED_NOTIFICATION,
    ...
    public List<Notification<?>> forOpponent() {
        var notification = new Notification<>(UNOCCUPIED_FIELD_ENEMY_CONQUEST_SUCCEEDED_NOTIFICATION,
